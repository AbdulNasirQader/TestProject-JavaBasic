...
public class VariablesDemo_1 {
    ...
    public static void main(String[] args) {
        int age=19;//requesting the computer to create a box of type int and store a value 10 in it.
        ...
        //System.ot.println(city); i have not stored anything inside the city variable thats why java is confused
        //what to print
