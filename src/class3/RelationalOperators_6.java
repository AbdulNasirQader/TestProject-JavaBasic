...
public class RelationalOperators_6 {
    public static void main(String[] args) {
        ...
        System.out.println(5>10);//is 5 greater then 10 => false
        System.out.println(5!=10);//is 5 not equal to 10 => true
        System.out.println(5==10);//is 5 equal to 10 => true
        ...
        System.out.println(10<=10);//is 10 less than or equal to 10 +> ture
