...
public class ConfigFileReadDemo1 {
    public static void main(String[] args) throws IOException {
        ...
        // if you face a issues hover your mouse and click on add exception to method signature
        FileInputStream fileInputStream=new FileInputStream(path);

        /*
        This "Properties" close will assist us to read and write data to .properties files
         */
